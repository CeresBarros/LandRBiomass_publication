...
test_dir("C:/Ceres/GitHub/LandRBiomass_publication/R/SpaDES/m/Biomass_validationKNN/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Ceres/GitHub/LandRBiomass_publication/R/SpaDES/m/Biomass_validationKNN/tests/testthat/test-template.R")
