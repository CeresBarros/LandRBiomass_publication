...
setPaths(modulePath = file.path("C:/Ceres/GitHub/LandRBiomass_publication/R/SpaDES/m"))
...
If `sourceURL` is specified, `downloadData("Biomass_validationKNN", "path/to/modules/dir")` may be sufficient.
