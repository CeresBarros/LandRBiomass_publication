...
knitr::opts_chunk$set(echo = TRUE, eval = isInteractive, results = "hold") ## TODO: set 'eval = TRUE'
```
...
```{r loadSimInit, include=FALSE, eval = !isInteractive}
LandRBiomass_simInit <- loadSimList(file.path("GitHubActionsSims", simDirName, runName, paste0("simInitbaseCase", runName)))
```
...
LandRBiomass_sim <- qs::qread(file.path("GitHubActionsSims", simDirName, runName, paste0("simList_LandRBiomass_sim_", runName)))
```
...
```{r plots, fig.show = "hold", eval = TRUE}
